# -*- coding: utf-8 -*-
#
# Yacms documentation build configuration file, created by
...
if "DJANGO_SETTINGS_MODULE" not in os.environ:
    docs_path = os.getcwd()
    Yacms_path_parts = (docs_path, "..")
    sys.path.insert(0, docs_path)
    sys.path.insert(0, os.path.realpath(os.path.join(*Yacms_path_parts)))
...
# run all the Yacms utils for dynamically generated docs.
if sys.argv[-2:] == ["docs", "docs/build"]:
    from Yacms.utils import docs
...
version = Yacms.__version__
# The full version, including alpha/beta/rc tags.
release = Yacms.__version__
...
latex_documents = [
    ('index', 'Yacms.tex', 'Yacms Documentation',
